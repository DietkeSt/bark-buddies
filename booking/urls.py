from . import views
from .views import ServiceList, ServiceDetail, BookServiceView, BookingsView, CancelBookingView, DeleteBookingView, AddCommentView, GetUnavailableTimes
from django.urls import path


urlpatterns = [
    path('', ServiceList.as_view(), name='home'),
    path('get-unavailable-times/', GetUnavailableTimes.as_view(),
